    ...
    public function up(): void
    {
        Schema::create('product_prices', function (Blueprint $table) {
            ...
            $table->decimal('current_price', 12, 2)->storedAs(
                'ROUND(CASE WHEN discount_type = "percent" THEN actual_price * (1 - discount_value / 100) WHEN discount_type = "flat" THEN actual_price - discount_value ELSE actual_price END, 2)'
            );
